...
export function InferredSkills({ skills }: { skills: InferredSkillDetail[] }) {
  ...
  return (
    <CardShell title="Inferred Skills" sub="not on the résumé — derived from context">
      <div style={{ paddingTop: 4, overflowY: "auto", maxHeight: 420 }}>
            ...
            return (
              <div key={s.name} style={{
                ...
                <div style={{
                  ...
                  {high && <Check size={12} strokeWidth={2.4} />}
                </div>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  {s.reason && (
                    <div style={{ fontSize: 14, color: "var(--fk-ink-3)", lineHeight: 1.5, margin: "5px 0 9px" }}>
                      {s.reason}
                    </div>
                  )}
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 6 }}>
                    <span style={{ fontSize: 13, fontWeight: 600, color: "var(--fk-ink-4)", textTransform: "uppercase", letterSpacing: "0.06em" }}>
                      via
                    </span>
                    {via.map((v, vi) => (
                    ...
                    <span style={{ color: "var(--fk-ink-4)", display: "inline-flex" }}>
                    ...
                    {s.inferred_by && (
                      <span style={{
                        marginLeft: "auto", fontSize: 12, fontFamily: "var(--font-geist-mono,monospace)",
