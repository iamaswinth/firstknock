    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--fk-page)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <p style={{ fontSize: 16, color: "var(--fk-ink-3)" }}>Loading your profile…</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--fk-page)" }}>
        <div style={{ textAlign: "center" }}>
          <p style={{ fontSize: 16, color: "var(--fk-ink-3)", marginBottom: 12 }}>Could not load your profile.</p>
          <button
            onClick={() => profile.refetch()}
            style={{ fontSize: 14, color: "var(--fk-brand)", background: "none", border: "none", cursor: "pointer", textDecoration: "underline" }}
          >
            Try again
          </button>
        </div>
